...
<head>
  ...
  if (isset($_POST['submit'])) {
    ...
    $up2 = mysqli_query($conn, "UPDATE pasien SET nama_pasien='$nama', tgl_lahir='$tgl' WHERE id='$id'");
    echo '<script>
				setTimeout(function() {
					swal({
					title: "Data Diubah",
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td align="center">
                                <form method="POST" action="detail_pasien.php">
                                  <span data-target="#editPasien" data-toggle="modal" data-id="<?php echo $idpasien; ?>" data-nama="<?php echo $row['nama_pasien']; ?>" data-lahir="<?php echo $row['tgl_lahir']; ?>" >
