...
<head>
  ...
  if ($page1 == "raw00") {
    ...
    $insert = mysqli_query($conn, "INSERT INTO pasien (nama_pasien, tgl_lahir, alamat, kode_pasien, jenis_kelamin, kornologi, tkp ) VALUES ('$nama', '$tgl', '$alm', '$kode', '$jk', '$ibu', '$job')");
    echo '<script>
				setTimeout(function() {
					swal({
    ...
    $submit = mysqli_query($conn, "INSERT INTO riwayat_penyakit (id_pasien, penyakit, diagnosa, tgl, biaya_pengobatan,  tensi, id_dokter) VALUES ('$id', '$penyakit', '$diagnosa', '$tglnow', '$biaya', '$tensi', '$doc')");
