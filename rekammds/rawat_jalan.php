                            ...
                            <div class="card-body">
                              <form class="needs-validation" novalidate="" method="POST" autocomplete="off" action="rawat_jalan_print.php">
                                <div class="form-group row align-items-center">
                                  <label class="col-md-4 text-md-right text-left required">Nama Lengkap Pasien</label>
                                ...
                                <div class="form-group row">
                                  <label class="col-md-4 text-md-right text-left required">Tanggal lahir Pasien</label>
                                  <div class="col-lg-6 col-md-6">
                                    <input type="date" class="form-control datepicker" name="tgl" required="" value="<?php echo date('Y-m-d'); ?>">
                                    <div class="invalid-feedback">
                                     * Mohon data diisi!
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                  <label class="col-md-4 text-md-right text-left required">Jenis Kelamin Pasien</label>
                                  <div class="col-lg-6 col-md-6">
                                ...
                                <div class="form-group row">
                                  <label class="col-md-4 text-md-right text-left required">Tempat Kejadian Perkara</label>
                                  <div class="col-lg-6 col-md-6">
                                    <input type="text" class="form-control" name="tkp" required="" placeholder="Tempat Kejadian Perkara">
                                    <div class="invalid-feedback">
                                     * Mohon data diisi!
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                  <label class="col-md-4 text-md-right text-left required">Kronologi</label>
                                  <div class="col-lg-6 col-md-6">
                                    <textarea type="number" class="form-control" name="kornologi" required="" placeholder="Kronologi"></textarea>
                                    <div class="invalid-feedback">
                                     * Mohon data diisi!
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                  <label class="col-md-4 text-md-right text-left required">Alamat / Tempat Tinggal Pasien</label>
                                  <div class="col-lg-6 col-md-6">
