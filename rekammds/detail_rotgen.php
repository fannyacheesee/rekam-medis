        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="pasien.php">Foto Pasien</a></div>
            ...
            <div class="section-body">
                      ...
                      <div class="gallery">
                        <table class="table table-striped table-sm">
                          <tbody>
                            ...
                            <tr>
                              <th scope="row">TKP</th>
                              <td> : <?php echo $pasien['tkp']; ?></td>
                            </tr>
                             <tr>
                              <th scope="row">Kronologi</th>
                              <td> : <?php echo $pasien['kronologi']; ?></td>
                            </tr>
                            <tr>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4>Semua Foto Pasien Meninggal  : <?php echo $echopen['penyakit']; ?></h4>
                    </div>
                    <div class="card-body">
